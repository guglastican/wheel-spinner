    ...
    <main class="main-content">
      ...
      <div class="wheel-description">
        ...
        <ul>
          ...
          <li><strong><router-link :to="localePath('/twister-spinner')">{{ $t('header.twisterSpinner') || 'Twister Spinner' }}</router-link>:</strong> <span v-html="$t('home.otherToolsList.twister') && $t('home.otherToolsList.twister').split('</strong>') ? $t('home.otherToolsList.twister').split('</strong>')[1] : ''"></span></li>
